...
jQuery.ajax = (function(_ajax){
	   ...
	   query = 'select * from htmlstring where url="{URL}" and xpath="*"&env=store://datatables.org/alltableswithkeys';
	   //https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20htmlstring%20where%20url%3D%22https%3A%2F%2Fgoogle.co.uk%22&format=json&diagnostics=true&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys&callback=
...
const leveldifference = [0,200,300,400,500,0]; //0,1,2,3,4,5. if level 1, needs 200 to level up, etc. 5 needs 0
        ...
        $(document).ready(function(){
              ...
              pointslink.attr({id:"pointstab",class:"tablinks",href:"javascript:void(0)",onclick:"openTab(event, 'Points')"});
              pointslink.append("Levels, Points & Misc. Calculator");
              pointstab.append(pointslink);
              var infotab = $(document.createElement('li'));
              var infolink = $(document.createElement('a'));
              infolink.attr({id:"infotab",class:"tablinks",href:"javascript:void(0)",onclick:"openTab(event, 'Information')"});
			...
			creditslink.attr({id:"creditstab",class:"tablinks",href:"javascript:void(0)",onclick:"openTab(event, 'Credits')"});
